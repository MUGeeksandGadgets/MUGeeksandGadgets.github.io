...
selectortemplate = readfile('templates/radioselector.css')
inlinetemplate = readfile('templates/inline.css')
...
for g in shelves.keys():
    ...
    # Add this genre to the list of radio selectors (for CSS).
    selectorlist.append(selectortemplate.format(genre=g))
...
inline = inlinetemplate.format(radioselectors=', '.join(selectorlist))
